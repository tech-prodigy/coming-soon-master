		...
		*/
		...
		if(!function_exists("coming_soon_meta_table"))
		{
			function coming_soon_meta_table()
			{
				...
				(10, 2, 'logo_image', '".COMING_SOON_CONTENT_URL."assets/admin/images/logo.png'),
				(11, 2, 'logo_link', 'show'),
				...
				(40, 6, 'upload_favicon', '".COMING_SOON_CONTENT_URL."/assets/admin/images/logo.png'),
				...
				(47, 7, 'choose_background', '".COMING_SOON_CONTENT_URL."assets/admin/images/background.png'),
				(48, 7, 'upload_image_background', '".COMING_SOON_CONTENT_URL."assets/admin/images/logo.png ,repeat,center,top'),
				...
				(58, 7, 'choose_slideshow', '".COMING_SOON_CONTENT_URL."assets/admin/images/slideshow.png'),
				(59, 7, 'upload_image_slideshow', '".COMING_SOON_CONTENT_URL."assets/admin/images/logo.png'),
				...
				(132, 15, 'font_family_error_subscription', 'Roboto Condensed'),
				...
				(156, 20, 'formatted_address', 'Singapore'),
				(157, 20, 'area_zip_code', 'Singapore 247964'),
				(158, 20, 'latitude', '1.330256'),
				(159, 20, 'longitude', '103.906374'),
				...
				(166, 2, 'custom_css_logo_settings_layout', ''),
				(167, 3, 'custom_css_heading_settings_layout', ''),
				(168, 4, 'custom_css_description_settings_layout', ''),
				(169, 5, 'custom_css_footer_settings_layout', ''),
				(170, 6, 'custom_css_favicon_layout', ''),
				(171, 7, 'custom_css_background_settings', ''),
				(172, 8, 'custom_css_countdown', ''),
				(173, 11, 'custom_css_heading_settings_subscription', ''),
				(174, 12, 'custom_css_description_settings_subscription', ''),
				(175, 13, 'custom_css_button_settings_subscription', ''),
				(176, 14, 'custom_css_success_settings_subscription', ''),
				(177, 15, 'custom_css_error_settings_subscription', ''),
				(178, 17, 'custom_css_label_contact_form', ''),
				(179, 18, 'custom_css_button_contact_form', ''),
				(180, 19, 'custom_css_success_contact_form', '');";
				dbDelta($variable);
			}
		}
