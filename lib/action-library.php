			...
			switch($_REQUEST["param"])
			{
				...
				case "logo_settings_module" :
					if(wp_verify_nonce($_REQUEST["_wp_nonce"], "coming_soon_master_logo_settings"))
					{
						...
						$update_logo_settings["logo_size"] = esc_attr($form_data["ux_ddl_logo_size"]);
						$update_logo_settings["max_width"] = esc_attr($form_data["ux_txt_width"]);
						$update_logo_settings["max_height"] = esc_attr($form_data["ux_txt_height"]);
