...
else
{
	...
	else
	{
		...
		$padding = explode(",",isset($meta_data_array["padding_countdown"]) ? $meta_data_array["padding_countdown"] : "");
		$margin = explode(",",isset($meta_data_array["margin_countdown"]) ? $meta_data_array["margin_countdown"] : "");
		$font_style= explode(",",isset($meta_data_array["font_style_countdown"]) ? $meta_data_array["font_style_countdown"] : "");
		$launch_time= explode(",",isset($meta_data_array["launch_time"]) ? $meta_data_array["launch_time"] : "");
					...
					<div class="col-md-12">
						<div class="portlet box purple">
							...
							<div class="portlet-body form">
								<form id="ux_frm_counter">
									<div class="form-body">
										<div class="form-group">
											<label class="control-label">
												<?php _e("Countdown Timer",coming_soon_master) ?> :
											...
											<select class="form-control" name="ux_ddl_countdown_timer" id="ux_ddl_countdown_timer" onchange="change_countdown_timer();" value="<?php echo isset($meta_data_array["countdown_timer"]) ? $meta_data_array["countdown_timer"] : "";?>">
										...
										<div id="ux_div_countdown_timer">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">
															<?php _e("Launch Date",coming_soon_master)?> :
															<i class="icon-question tooltips" data-original-title="<?php _e("Please Enter Your Launch Date Here",coming_soon_master)?>" data-placement="right"></i>
															<span class="required" aria-required="true">*</span>
														</label>
														<input type="text" class="form-control" name="ux_txt_launch_date" id="ux_txt_launch_date" placeholder="<?php _e("Enter Your Launch Date Here",coming_soon_master)?>" value="<?php echo isset($meta_data_array["launch_date"]) ? $meta_data_array["launch_date"] : "";?>">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">
															<?php _e("Launch Time",coming_soon_master)?> :
															<i class="icon-question tooltips" data-original-title="<?php _e("Please Select Launch Time",coming_soon_master)?>" data-placement="right"></i>
															<span class="required" aria-required="true">*</span>
														</label>
											...
											<div class="form-group">
												<label class="control-label">
													<?php _e("Time Zone",coming_soon_master) ?> :
													<i class="icon-question tooltips" data-original-title="<?php _e("Please Select Time Zone Here",coming_soon_master)?>" data-placement="right"></i>
													<span class="required" aria-required="true">*</span>
												</label>
												<select class="form-control" name="ux_ddl_time_zone" id="ux_ddl_time_zone" value="<?php echo isset($meta_data_array["time_zone"]) ? $meta_data_array["time_zone"] : "";?>">
													...
													<option value="Asia/Magadan">(UTC+12:00) New Caledonia, Solomon Is.</option>
											...
											<div class="form-group">
												<label class="control-label">
													<?php _e("Countdown Text",coming_soon_master)?> :
													<i class="icon-question tooltips" data-original-title="<?php _e("Please Enter Your Countdown Text Here",coming_soon_master)?>" data-placement="right"></i>
													<span class="required" aria-required="true">*</span>
												</label>
												<input type="text" class="form-control" name="ux_txt_countdown_text" id="ux_txt_countdown_text" placeholder="<?php _e("Please Enter Your Countdown Text Here",coming_soon_master)?>" value="<?php echo stripslashes(urldecode(isset($meta_data_array["countdown_text"]) ? $meta_data_array["countdown_text"] : ""));?>">
											</div>
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
											...
											<div class="form-group">
												...
												<select class="form-control" name="ux_ddl_countdown_position" id="ux_ddl_countdown_position" value="<?php echo isset($meta_data_array["countdown_position"]) ? $meta_data_array["countdown_position"] : "";?>">
										...
										<div class="form-actions">
											<div class="pull-right">
												<input type="submit" class="btn purple" id="btn_save_settings_countdown" name="btn_save_settings_countdown" value="<?php _e("Save Settings",coming_soon_master);?>">
											</div>
										</div>
									</div>
								</form>
