...
else
{
	...
	else
	{
		...
		$padding = explode(",",isset($meta_data_array["padding_footer"]) ? $meta_data_array["padding_footer"] : "");
								...
								<form id="ux_frm_footer_settings">
									<div class="form-body">
										<div class="form-group">
											...
											<select class="form-control" name="ux_ddl_footer_settings" id="ux_ddl_footer_settings" onchange="change_footer_settings();" value="<?php echo isset($meta_data_array["footer_settings"]) ? $meta_data_array["footer_settings"] : "";?>">
												<option value="show"><?php _e("Show",coming_soon_master)?></option>
												<option value="hide"><?php _e("Hide",coming_soon_master)?></option>
											</select>
										</div>
										<div id="ux_div_footer_text">
											<div class="form-group">
												<label class="control-label">
													<?php _e("Footer Text",coming_soon_master) ?> :
													<i class="icon-question tooltips" data-original-title="<?php _e("Please Enter Text Here",coming_soon_master)?>" data-placement="right"></i>
													<span class="required" aria-required="true">*</span>
												</label>
												<?php
												$distribution = stripslashes(urldecode(isset($meta_data_array["footer_text"]) ? $meta_data_array["footer_text"] : "")); 
												wp_editor( $distribution, $id ="ux_footer_content", array("media_buttons" => false, "textarea_rows" => 8, "tabindex" => 4 ) ); 
												?>
											</div>
											<div class="row">
												<div class="col-md-6">
											...
											<div class="form-group">
												<label class="control-label">	
													<?php _e("Footer Position",coming_soon_master)?> :
													<i class="icon-question tooltips" data-original-title="<?php _e("Please Select Footer Position",coming_soon_master)?>" data-placement="right"></i>
													<span class="required" aria-required="true">*</span>
												</label>
												<select class="form-control" name="ux_ddl_footer_position" id="ux_ddl_footer_position" value="<?php echo isset($meta_data_array["footer_position"]) ? $meta_data_array["footer_position"] : "";?>">
											...
											<div class="form-group">
												...
												<textarea class="form-control" name="ux_txtarea_css_footer" id="ux_txtarea_css_footer" placeholder="<?php _e("Enter Custom CSS",coming_soon_master); ?>"></textarea>
											</div>
										</div>
										<div class="line-separator"></div>
										<div class="form-actions">
											<div class="pull-right">
												<input type="submit" class="btn purple" id="btn_save_footer_settings" name="btn_save_footer_settings" value="<?php _e("Save Settings",coming_soon_master);?>">
											</div>
										</div>
									</div>
								</form>
