									...
									<div class="form-body">
										...
										<div class="form-actions">
											<div class="pull-right">
												<input type="submit" class="btn purple  system-report" name="ux_btn_system_information"  id="ux_btn_system_information" value="<?php _e("Get System Inforamtion!",coming_soon_master)?>">
											</div>
										</div>
										<div class="custom-form-body">
											<h3 class="form-section">
												<?php _e("Server Information",coming_soon_master); ?>
											</h3>
											<table class="table table-striped table-bordered table-hover" >
												<thead class="align-thead-left">
													<tr>
														<th class="custom-table-th-left" style="width: 40% !important;">
															<?php _e("Environment Key",coming_soon_master); ?>
														</th>
														<th class="custom-table-th-right">
															<?php _e("Environment Value",coming_soon_master); ?>
														</th>
													</tr>
												</thead>
												<tbody>
												<tr>
													<td>
														<strong>
															<?php _e("Home URL",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("Site URL",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("WP Version",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("WP Multisite Enabled",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("WP Remote Post",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("Web Server Info",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("PHP Version",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("MySQL Version",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("WP Debug Mode",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("WP Language",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
															<?php if (defined("WPLANG") && WPLANG) echo WPLANG; else _e("Default"); ?>
														</span>
													</td>
												</tr>
												<tr>
													<td>
														<strong>
															<?php _e("WP Max Upload Size",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<?php if (function_exists("ini_get")) : ?>
													<tr>
														<td>
															<strong>
																<?php _e("PHP Max Script Execute Time",coming_soon_master); ?> :
															</strong>
														</td>
														<td>
															<span>
													...
													<tr>
														<td>
															<strong>
																<?php _e("PHP Max Input Vars",coming_soon_master); ?> :
															</strong>
														</td>
														<td>
															<span>
													...
													<tr>
														<td>
															<strong>
																<?php _e("SUHOSIN Installed",coming_soon_master); ?> :
															</strong>
														</td>
														<td>
															<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("Default Timezone",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("Operating System",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("Memory usage",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("SQL Mode",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("PHP Safe Mode",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("PHP Allow URL fopen",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("PHP Memory Limit",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("PHP Max Post Size",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("PCRE Backtracking Limit",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("PHP Exif support",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span> 
												...
												<tr>
													<td>
														<strong>
															<?php _e("PHP IPTC support",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
												...
												<tr>
													<td>
														<strong>
															<?php _e("PHP XML support",coming_soon_master); ?> :
														</strong>
													</td>
													<td>
														<span>
										...
										<div class="custom-form-body">
											<h3 class="form-section">
												<?php _e("Active  Plugin Information",coming_soon_master); ?>
											</h3>
											<table class="table table-striped table-bordered table-hover">
												<thead class="align-thead-left">
												<tr>
													<th class="custom-table-th-left" style="40% !important;">
														<?php _e("Plugin Key",coming_soon_master); ?>
													</th>
													<th class="custom-table-th-right">
														<?php _e("Plugin Value",coming_soon_master); ?>
													</th>
												</tr>
												</thead>
												<tbody>
										...
										if($wp_version >= 3.4) {
											...
											<div class="custom-form-body">
												<h3 class="form-section">
													<?php _e("Active Theme Information",coming_soon_master); ?>
												</h3>
												<table class="table table-striped table-bordered table-hover">
													<thead class="align-thead-left">
													<tr>
														<th style="width: 40% !important;" class="custom-table-th-left">
															<?php _e ( "Theme Key" ,coming_soon_master ); ?>
														</th>
														<th class="custom-table-th-right">
															<?php _e ( "Theme Value" ,coming_soon_master ); ?>
														</th>
													</tr>
													</thead>
													<tbody>
													<tr>
														<td>
															<strong>
																<?php _e ( "Theme Name" ,coming_soon_master ); ?> :
															</strong>
														</td>
														<td>
															<span>
													...
													<tr>
														<td>
															<strong>
																<?php _e ( "Theme Version" ,coming_soon_master ); ?> :
															</strong>
														</td>
														<td>
															<span>
													...
													<tr>
														<td>
															<strong>
																<?php _e ( "Author URL" ,coming_soon_master ); ?> :
															</strong>
														</td>
														<td>
															<span>
										...
										<div class="custom-form-body">
											<h3 class="form-section">
												<?php _e("GB Library Information",coming_soon_master); ?>
											</h3>
											<table class="table table-striped table-bordered table-hover" >
												<thead class="align-thead-left">
												<tr>
													<th style="width: 40% !important;" class="custom-table-th-left">
														<?php _e("GD Key",coming_soon_master); ?>
													</th>
													<th class="custom-table-th-right">
														<?php _e("GD Value",coming_soon_master); ?>
													</th>
												</tr>
												</thead>
												<tbody>
