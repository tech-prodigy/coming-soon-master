												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="input-icon right">
															...
															<select class="form-control input-width-25 input-inline" name="ux_ddl_font_style_heading_subscription" id="ux_ddl_font_heading_settings_subscription">
															...
															<input type="text" name="ux_ddl_font_style_heading_subscription" id="ux_clr_heading_settings_subscription" class="form-control input-normal input-inline" placeholder="<?php _e("Color",coming_soon_master)?>" value="<?php echo $font_style[2];?>">
														</div>
													</div>
												</div>
												<div class="col-md-6">
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="input-icon right">
															<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_heading_margin_text" id="ux_txt_marginj_text" placeholder="<?php _e("Top",coming_soon_master)?>" value="<?php echo $margin[0];?>">
															<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_heading_margin_text" id="ux_txt_margink_text" placeholder="<?php _e("Right",coming_soon_master)?>" value="<?php echo $margin[1];?>">
															<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_heading_margin_text" id="ux_txt_marginl_text" placeholder="<?php _e("Bottom",coming_soon_master)?>" value="<?php echo $margin[2];?>">
															<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_heading_margin_text" id="ux_txt_marginz_text" placeholder="<?php _e("Left",coming_soon_master)?>" value="<?php echo $margin[3];?>">
														</div>
													</div>
												</div>
												<div class="col-md-6">
